------------------------------------------------------------------------------
--- This library contains `ReadWrite` instances for the types defined in
--- `FlatCurry.Types`. These instances can be used by `RW.Base`
--- to support writing and reading compact files containing FlatCurry programs.
--- This file has been generated by the tool `curry-rw-data`.
---
...
instance ReadWrite Visibility where
  readRW _ ('0' : r0) = (Public,r0)
  readRW _ ('1' : r0) = (Private,r0)

  showRW _ strs0 Public = (strs0,showChar '0')
  showRW _ strs0 Private = (strs0,showChar '1')

  writeRW _ h Public strs = hPutChar h '0' >> return strs
  writeRW _ h Private strs = hPutChar h '1' >> return strs
...
instance ReadWrite Kind where
  readRW _ ('0' : r0) = (KStar,r0)
  readRW strs ('1' : r0) = (KArrow a' b',r2)
    where
      (a',r1) = readRW strs r0
      (b',r2) = readRW strs r1

  showRW _ strs0 KStar = (strs0,showChar '0')
  showRW params strs0 (KArrow a' b') = (strs2,showChar '1' . (show1 . show2))
    where
      (strs1,show1) = showRW params strs0 a'
      (strs2,show2) = showRW params strs1 b'

  writeRW _ h KStar strs = hPutChar h '0' >> return strs
...
instance ReadWrite Fixity where
  readRW _ ('0' : r0) = (InfixOp,r0)
  readRW _ ('1' : r0) = (InfixlOp,r0)
  readRW _ ('2' : r0) = (InfixrOp,r0)

  showRW _ strs0 InfixOp = (strs0,showChar '0')
  showRW _ strs0 InfixlOp = (strs0,showChar '1')
  showRW _ strs0 InfixrOp = (strs0,showChar '2')

  writeRW _ h InfixOp strs = hPutChar h '0' >> return strs
  writeRW _ h InfixlOp strs = hPutChar h '1' >> return strs
  writeRW _ h InfixrOp strs = hPutChar h '2' >> return strs
...
instance ReadWrite CaseType where
  readRW _ ('0' : r0) = (Rigid,r0)
  readRW _ ('1' : r0) = (Flex,r0)

  showRW _ strs0 Rigid = (strs0,showChar '0')
  showRW _ strs0 Flex = (strs0,showChar '1')

  writeRW _ h Rigid strs = hPutChar h '0' >> return strs
  writeRW _ h Flex strs = hPutChar h '1' >> return strs

  typeOf _ = monoRWType "CaseType"

instance ReadWrite CombType where
  readRW _ ('0' : r0) = (FuncCall,r0)
  readRW _ ('1' : r0) = (ConsCall,r0)
  ...
  showRW _ strs0 FuncCall = (strs0,showChar '0')
  showRW _ strs0 ConsCall = (strs0,showChar '1')
  ...
  writeRW _ h FuncCall strs = hPutChar h '0' >> return strs
  writeRW _ h ConsCall strs = hPutChar h '1' >> return strs
